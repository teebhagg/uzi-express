        ...
        setIsLoading(true);
            ...
            if (userRes.ok) {
                toast({
                    ...
                    description: "This user already exists, please sign in.",
                });
...
// Handle Google sign in
  ...
  return (
    ...
    <OTPDialog email={form.getValues("email")} password={form.getValues("password")} open={openDialog} onOpenChange={setOpenDialog} />
    </div>
  )
}
